...
module.exports = {
    ...
    pow: {
        getDifficulty: (blocks, index) => {
            ...
            const BASE_DIFFICULTY = Number.BASE_DIFFICULTY;
    ...
    TARGET_BLOCK_TIME: 2, // Target time in seconds for mining a block (e.g., 10 minutes)
    DIFFICULTY_ADJUSTMENT_INTERVAL: 5, // Number of blocks to consider for difficulty adjustment
};